anno = read.table('arab_files_N/arab_anno_fin.txt')

###
anno$End = anno$Start.1
###
anno$len=anno$End-anno$Start
promoters=read.table("arab_files_N/Promoters_final_arab.txt",sep="\t",header=T)
terminator=read.table("arab_files_N/4tss_arab_mrnas2.txt",sep="\t",header=T)
