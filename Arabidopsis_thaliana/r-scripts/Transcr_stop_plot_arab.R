...
atg=read.table("arab_files_N/ATGs_arabidopsis.txt",sep="\t",header=T)
#atg=read.table("arab_files_N/4tss_arab_mrnas2.txt",sep="\t",header=T)
...
dev.off()
library(scales)
plot(type='n',plot_df_final$V1,plot_df_final$V2,main="Number of SNPs near ATG",xlab="Distanse from ATG",ylab="Number of SNPs per 1000 genes")
